...
public class ApplicationContextExtendsFindTest {
    ...
    void findAllBeanByParentType() {
        ...
        * 출력 결과
        * 
        * key = rateDiscountPolicy value = hello.core.discount.RateDiscountPolicy@35beb15e
        * key = fixDiscountPolicy value = hello.core.discount.FixDiscountPolicy@41fe9859
        * */
    }
